...
def quick_start(model, dataset, config_dict, model_pth = None, save_model=True):
    # merge config dict
    ...
    for hyper_tuple in combinators:
        ...
        if best_test_upon_valid[val_metric] > best_test_value:
            ...
            model_save_path = os.path.join(config['checkpoint_dir'], f'model2_best.pth') #2번째 모델로 수정
